	...
	<?php
		...
		require_once "detalhesAlunos.php";
	?>
	...
	<div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="descricao_deficiencia" placeholder="" name="descricao_deficiencia" value="<?php echo $ret[0]->descricao_deficiencia;?>" readonly>
    </div>
</div>
  <?php
